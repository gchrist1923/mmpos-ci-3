...
<section class="content">
  <div class="box">
    <div class="box-header">
      <h3 class="box-title"> Tambah Stock In</h3>
      <div class="pull-right">
        <a href="<?= site_url('stock/in'); ?>" class="btn btn-default btn-flat">
        ...
        <div class="col-md-4 col-md-offset-4">
          <form action="<?= site_url('stock/proses') ?>" method="POST">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="number" value="" name="qty" min="1" required>
            </div>
